          ...
          <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-amber-50 rounded-xl p-6">
              ...
              <div class="bg-white rounded-lg p-4 border border-amber-200">
                <pre class="text-slate-700 whitespace-pre-wrap font-mono text-sm">{{ project.contactInfo }}</pre>
              </div>
            </div>
          </div>
            ...
            <div class="bg-white rounded-xl border border-slate-200 p-6">
              ...
              <div class="space-y-4">
                ...
                <div class="flex justify-between items-center">
                  ...
                  <span class="font-semibold text-slate-900">{{ formatDate(project.createdAt) }}</span>
                </div>
                <div class="flex justify-between items-center">
                  <span class="text-slate-600">更新时间</span>
                  <span class="font-semibold text-slate-900">{{ formatTime(project.updatedAt) }}</span>
                </div>
              </div>
            </div>
            ...
            <div v-if="project.startDate" class="bg-white rounded-xl border border-slate-200 p-6">
              ...
              <div class="space-y-3">
                <div class="flex justify-between items-center">
                  ...
                  <span class="font-semibold text-slate-900">{{ formatDate(project.startDate) }}</span>
                </div>
                <div v-if="project.endDate" class="flex justify-between items-center">
                  <span class="text-slate-600">预期结束</span>
                  <span class="font-semibold text-slate-900">{{ formatDate(project.endDate) }}</span>
                </div>
              </div>
            </div>
          </div>
